...
/** Return a unix-ms-to-EST-time phase detector. All times in America/New_York. */
export function currentEstHour(): { dayOfWeek: number; hour: number; minute: number } {
	// Use Intl.DateTimeFormat with America/New_York for correct DST handling
